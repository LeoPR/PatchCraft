...
**B5. THEORY §9 se contradiz sobre a promoção fp16.** §9 se declara árbitro do contrato (`THEORY.md:235`) e o árbitro aceita (`:271`) e exclui (`:279`) o mesmo comportamento. Edição de duas linhas em um documento que não pode ser congelado contraditório.
