...
São 1571 testes coletados, com CI verde em {Ubuntu, Windows} x {Python 3.12, 3.13}, e com `ruff check` e `mypy --strict` na mesma execução. O pacote é tipado e distribui o `py.typed`.
